...
conv_model.fit(X_train, Y_train, epochs=100, batch_size=16, validation_data=(X_cv, y_cv))
...
conv_model.fit(X_train, Y_train, epochs=100, validation_data=(X_cv, y_cv))
